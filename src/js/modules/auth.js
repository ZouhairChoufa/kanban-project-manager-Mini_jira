...
async function handleSignUp(e) {
    ...
    try {
        ...
        dom.signupError.textContent = getFriendlyAuthError(error);
...
async function handleLogin(e) {
    ...
    try {
        ...
        dom.loginError.textContent = getFriendlyAuthError(error);
...
function setAuthLoading(button, isLoading) {
    ...
    if (isLoading) {
        ...
        button.innerHTML = button.id === 'login-submit-btn' ? 'Se connecter' : 'Créer un compte';
    }
}
